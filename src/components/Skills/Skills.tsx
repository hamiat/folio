      ...
      {whichTitle ? (
        <motion.div variants={parentContainer} className={style.experiencesDiv}>
          ...
          >
            {title}{" "}
            <motion.span
              initial={{ color: "#ffc380" }}
              className={style.clickMe}
            >
              <FaLongArrowAltLeft className={style.leftArrow} />
              <FaLongArrowAltUp className={style.upArrow} /> click me for
              experiences!
            </motion.span>{" "}
          </motion.h2>
          <div className={style.experiences}>
            <motion.div variants={contentVariants} className={style.exp}>
              <h3>
                Hyper Island
                <span className={style.city}>, Stockholm (Sweden) </span>
              </h3>
              <div className={style.jobTitleDiv}>
                <h4>Frontend Developer</h4>
                <span className={style.expSpan}>August 2020 - April 2022 </span>
              </div>
            ...
            <motion.div variants={contentVariants} className={style.exp}>
              <h3>
                ...
                <span className={style.city}>, Seoul (South Korea) </span>
              </h3>
              <div className={style.jobTitleDiv}>
                <h4>Exchange Year</h4>
                <span className={style.expSpan}>August 2014 - June 2015</span>
              </div>
            ...
            <motion.div variants={contentVariants} className={style.exp}>
              <h3>
                ...
                <span className={style.city}>, Västerås (Sweden)</span>
              </h3>
              <div className={style.jobTitleDiv}>
                <h4>Aeronautical Engineering</h4>
                <span className={style.expSpan}>August 2011 - June 2013 </span>
              </div>
          ...
          <div className={style.experiences}>
            <motion.div variants={contentVariants} className={style.exp}>
              ...
              <div className={style.jobTitleDiv}>
                ...
                <span className={style.expSpan}>September 2021 - ongoing </span>
              </div>

              <p>
                - Created the company’s landing page, from design to deployment
                (continuous deployment).
                <br />- Worked with Figma, React, Next.js, TypeScript and Sass
                for this project, as well as Github for collaboration with a
                fellow intern.
              </p>
            </motion.div>
            ...
            <motion.div variants={contentVariants} className={style.exp}>
              ...
              <div className={style.jobTitleDiv}>
                ...
                <span className={style.expSpan}>June 2019 - August 2020 </span>
              </div>
            ...
            <motion.div variants={contentVariants} className={style.exp}>
              <div className={style.jobTitleDiv}>
                ...
                <span className={style.expSpan}>March 2016 - June 2019 </span>
              </div>
