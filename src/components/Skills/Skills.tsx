...
const Skills: React.FC = () => {
  return (
    ...
    >
      ...
      <motion.div variants={parentContainer} className={style.softSkills}>
      <motion.h2 variants={titleVariants}>Skills</motion.h2>
		...
		162.064,370.201 238.404,349.043 238.963,342.752 247.715,244.717 248.623,234.718 238.588,234.718 	"
                ...
                <g>
                  <polygon
                    fill="#fff"
                    points="214.945,30.571 190.256,30.571 215.932,58.431 215.932,71.691 163.049,71.691 163.049,56.165 
			188.719,56.165 163.049,28.306 163.049,15.025 214.945,15.025 214.945,30.571 		"
                  />
                  <path
                    fill="#fff"
                    d="M153.631,15.05v56.617h-45.543V52.953h26.613V15.05h18.928H153.631z"
                  />
                </g>
                <path fill="#FFFFFF" d="M239.51,173.693" />
              </g>
            </svg>
            <svg className={style.react}
              version="1.1"
              id="Layer_2_1_"
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
